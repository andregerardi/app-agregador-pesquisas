...
:root{
  ...
  --accent-soft: #F4E8C8;
  --border: #E6E8EF;
  --shadow-sm: 0 2px 8px rgba(16,33,61,0.06);
  --shadow-md: 0 10px 30px rgba(16,33,61,0.10);
  --radius: 14px;
}
...
/* ---------- Subtítulo (h4 SEM background) ---------- */
h4[style]:not([style*="background-color"]){
...
with st.container():
    ...
    with col3:
        ...
        <h6 style='text-align: center; color: #54595F;'>Coordenação:</h6><p style='text-align: center;'>Dirceu André Gerardi<br>(FGV Projetos/Cebrap)<br><a href="mailto: andregerardi3@gmail.com">email<br></a><br>Ronaldo de Almeida<br>(UNICAMP/CEBRAP/LAR)<br><a href="mailto: ronaldormalmeida@gmail.com">email</a></p></p>
        """, unsafe_allow_html=True)
    st.markdown("---")
