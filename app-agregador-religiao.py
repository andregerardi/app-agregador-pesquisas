...
with st.container():
    ...
    with col4:
        ...
        <p style='text-align: justify; font-family:Segoe UI;'>5. Devido à irregularidade na coleta e ao tamanho da amostra, dados referentes a segmentos demograficamente minoritários tal como candomblé/umbanda e outros apresentam margens de erro maiores, uma vez que a amostra destas religiões não é representativa do conjunto da população brasileira. Assim, quando possível, decidiu-se incluí-las na categoria "Outras religiosidades";</p>
        <p style='text-align: justify; font-family:Segoe UI;'>6. Para a composição do banco de dados são consideradas apenas pesquisas nacionais, bem como informações de Lula, Bolsonaro e Ciro Gomes no primeiro turno das eleições presidenciais e de Lula e Bolsonaro no 2º turno;</p>
        ...
        <p style='text-align: justify; font-family:Segoe UI;'>11. Ao calcular a média móvel de {m_m} dias, por exemplo, os {m_m} primeiros resultados são omitidos da série temporal e não aparecem nos gráficos. O objetivo principal da aplicação deste método é reduzir as oscilações no intuito de deixar as linhas dos gráficos mais fluídas. Exitem algumas técnicas estatíticas para a redução do ruído dos dados da série temporal, tais como <i>weighted moving average, kernel smoother</i>, entre outras;</p>
