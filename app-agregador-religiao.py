...
# ╔══════════════════════════════════════════════════════════════════════╗
# ║ BLOCO B — Hero header                                                  ║
# ║ SUBSTITUI: os 3 st.markdown de "## titulo", "## subtítulo" e todo o   ║
# ║ bloco "## compartilhamento" (col3,col4,col5 = st.columns...).          ║
# ╚══════════════════════════════════════════════════════════════════════╝
 
st.markdown("""
     <div class="hero">
       <span class="kicker">Cebrap · LAR/Unicamp · Eleições 2022</span>
